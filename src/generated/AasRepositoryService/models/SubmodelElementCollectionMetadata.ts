...
/**
 * Check if a given object implements the SubmodelElementCollectionMetadata interface.
 */
export function instanceOfSubmodelElementCollectionMetadata(value: object): value is SubmodelElementCollectionMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function SubmodelElementCollectionMetadataFromJSON(json: any): SubmodelElementCollectionMetadata {
    return SubmodelElementCollectionMetadataFromJSONTyped(json, false);
}

export function SubmodelElementCollectionMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubmodelElementCollectionMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function SubmodelElementCollectionMetadataToJSON(json: any): SubmodelElementCollectionMetadata {
    return SubmodelElementCollectionMetadataToJSONTyped(json, false);
}

export function SubmodelElementCollectionMetadataToJSONTyped(value?: SubmodelElementCollectionMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
