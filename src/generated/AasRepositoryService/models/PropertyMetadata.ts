...
/**
 * Check if a given object implements the PropertyMetadata interface.
 */
export function instanceOfPropertyMetadata(value: object): value is PropertyMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function PropertyMetadataFromJSON(json: any): PropertyMetadata {
    return PropertyMetadataFromJSONTyped(json, false);
}

export function PropertyMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PropertyMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function PropertyMetadataToJSON(json: any): PropertyMetadata {
    return PropertyMetadataToJSONTyped(json, false);
}

export function PropertyMetadataToJSONTyped(value?: PropertyMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
