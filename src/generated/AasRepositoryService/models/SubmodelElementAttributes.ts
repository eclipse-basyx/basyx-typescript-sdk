...
/**
 * Check if a given object implements the SubmodelElementAttributes interface.
 */
export function instanceOfSubmodelElementAttributes(value: object): value is SubmodelElementAttributes {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function SubmodelElementAttributesFromJSON(json: any): SubmodelElementAttributes {
    return SubmodelElementAttributesFromJSONTyped(json, false);
}

export function SubmodelElementAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubmodelElementAttributes {
    if (json == null) {
        return json;
    }
    return {
...
export function SubmodelElementAttributesToJSON(json: any): SubmodelElementAttributes {
    return SubmodelElementAttributesToJSONTyped(json, false);
}

export function SubmodelElementAttributesToJSONTyped(value?: SubmodelElementAttributes | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
