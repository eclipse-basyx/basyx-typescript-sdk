...
/**
 * Check if a given object implements the MultiLanguagePropertyMetadata interface.
 */
export function instanceOfMultiLanguagePropertyMetadata(value: object): value is MultiLanguagePropertyMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function MultiLanguagePropertyMetadataFromJSON(json: any): MultiLanguagePropertyMetadata {
    return MultiLanguagePropertyMetadataFromJSONTyped(json, false);
}

export function MultiLanguagePropertyMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiLanguagePropertyMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function MultiLanguagePropertyMetadataToJSON(json: any): MultiLanguagePropertyMetadata {
    return MultiLanguagePropertyMetadataToJSONTyped(json, false);
}

export function MultiLanguagePropertyMetadataToJSONTyped(value?: MultiLanguagePropertyMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
