...
/**
 * Check if a given object implements the AnnotatedRelationshipElementMetadata interface.
 */
export function instanceOfAnnotatedRelationshipElementMetadata(value: object): value is AnnotatedRelationshipElementMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function AnnotatedRelationshipElementMetadataFromJSON(json: any): AnnotatedRelationshipElementMetadata {
    return AnnotatedRelationshipElementMetadataFromJSONTyped(json, false);
}

export function AnnotatedRelationshipElementMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnnotatedRelationshipElementMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function AnnotatedRelationshipElementMetadataToJSON(json: any): AnnotatedRelationshipElementMetadata {
    return AnnotatedRelationshipElementMetadataToJSONTyped(json, false);
}

export function AnnotatedRelationshipElementMetadataToJSONTyped(value?: AnnotatedRelationshipElementMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
