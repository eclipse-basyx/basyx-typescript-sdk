...
import type { BlobAllOfContentType } from './BlobAllOfContentType';
import {
    BlobAllOfContentTypeFromJSON,
    BlobAllOfContentTypeFromJSONTyped,
    BlobAllOfContentTypeToJSON,
    BlobAllOfContentTypeToJSONTyped,
} from './BlobAllOfContentType';
...
export function BlobFromJSONTyped(json: any, ignoreDiscriminator: boolean): Blob {
    ...
    return {
        ...
        'contentType': BlobAllOfContentTypeFromJSON(json['contentType']),
    };
}
...
export function BlobToJSONTyped(value?: Blob | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'value': value['value'],
        'contentType': BlobAllOfContentTypeToJSON(value['contentType']),
    };
}
