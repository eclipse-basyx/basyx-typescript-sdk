...
/**
 * Check if a given object implements the DataElement interface.
 */
export function instanceOfDataElement(value: object): value is DataElement {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function DataElementFromJSON(json: any): DataElement {
    return DataElementFromJSONTyped(json, false);
}

export function DataElementFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataElement {
    if (json == null) {
        return json;
    }
    return {
...
export function DataElementToJSON(json: any): DataElement {
    return DataElementToJSONTyped(json, false);
}

export function DataElementToJSONTyped(value?: DataElement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
