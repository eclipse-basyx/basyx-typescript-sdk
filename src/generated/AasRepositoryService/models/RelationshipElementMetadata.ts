...
/**
 * Check if a given object implements the RelationshipElementMetadata interface.
 */
export function instanceOfRelationshipElementMetadata(value: object): value is RelationshipElementMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function RelationshipElementMetadataFromJSON(json: any): RelationshipElementMetadata {
    return RelationshipElementMetadataFromJSONTyped(json, false);
}

export function RelationshipElementMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationshipElementMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function RelationshipElementMetadataToJSON(json: any): RelationshipElementMetadata {
    return RelationshipElementMetadataToJSONTyped(json, false);
}

export function RelationshipElementMetadataToJSONTyped(value?: RelationshipElementMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
