...
/**
 * Check if a given object implements the CapabilityMetadata interface.
 */
export function instanceOfCapabilityMetadata(value: object): value is CapabilityMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function CapabilityMetadataFromJSON(json: any): CapabilityMetadata {
    return CapabilityMetadataFromJSONTyped(json, false);
}

export function CapabilityMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CapabilityMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function CapabilityMetadataToJSON(json: any): CapabilityMetadata {
    return CapabilityMetadataToJSONTyped(json, false);
}

export function CapabilityMetadataToJSONTyped(value?: CapabilityMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
