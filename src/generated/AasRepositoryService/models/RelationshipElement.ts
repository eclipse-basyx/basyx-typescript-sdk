...
/**
 * Check if a given object implements the RelationshipElement interface.
 */
export function instanceOfRelationshipElement(value: object): value is RelationshipElement {
...
export function RelationshipElementFromJSON(json: any): RelationshipElement {
    return RelationshipElementFromJSONTyped(json, false);
}

export function RelationshipElementFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationshipElement {
    if (json == null) {
        return json;
    }
    return {
...
export function RelationshipElementToJSON(json: any): RelationshipElement {
    return RelationshipElementToJSONTyped(json, false);
}

export function RelationshipElementToJSONTyped(value?: RelationshipElement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
