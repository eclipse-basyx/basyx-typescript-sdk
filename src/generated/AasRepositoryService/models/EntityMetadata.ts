...
/**
 * Check if a given object implements the EntityMetadata interface.
 */
export function instanceOfEntityMetadata(value: object): value is EntityMetadata {
    if (!('modelType' in value) || value['modelType'] === undefined) return false;
    return true;
}

export function EntityMetadataFromJSON(json: any): EntityMetadata {
    return EntityMetadataFromJSONTyped(json, false);
}

export function EntityMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityMetadataToJSON(json: any): EntityMetadata {
    return EntityMetadataToJSONTyped(json, false);
}

export function EntityMetadataToJSONTyped(value?: EntityMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
