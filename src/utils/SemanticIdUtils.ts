 ...
 *
 * @param {ISubmodelElement} submodelElement - The SubmodelElement object containing semantic ID keys.
 ...
 */
export function checkSemanticId(submodelElement: ISubmodelElement, semanticId: string): boolean {
